...
save('dispersion_image_data','Wn','f','c'); in this MATLAB script. This dispersion_image_data.mat file can be used in paper1_code_qf.m code to calculate quality factor. The supplementary data of dispersion image cannot be provided due to large size of the variables.
...
The dispersion_image_data.mat file contains the dispersion image data; normalizes amplitude array Wn, frequency vector f and velocity vector c. The data in this file can be used in paper1_code_qf.m code to calculate quality factor of different modes present in the dispersion image.